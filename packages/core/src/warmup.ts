...
documentWarmer('https://schema.owlmeans.com/did-schema.json#', JSON.stringify(didSchema))
documentWarmer('https://schema.owlmeans.com/schemas/did-schema.json', JSON.stringify(didSchema))
documentWarmer('https://schema.owlmeans.com/schema/auth-request', JSON.stringify(authRequest))
documentWarmer('https://schema.owlmeans.com/schema/auth', JSON.stringify(auth))
documentWarmer('https://schema.owlmeans.com/schema/doc-signature', JSON.stringify(docSignature))
documentWarmer('https://schema.owlmeans.com/schema/doc-signature-request', JSON.stringify(docSignatureReq))
documentWarmer('https://schema.owlmeans.com/schema/group-membership', JSON.stringify(groupMembership))
documentWarmer('https://schema.owlmeans.com/schema/group', JSON.stringify(group))
documentWarmer('https://schema.owlmeans.com/schema/identity', JSON.stringify(identity))
